...
var NumbersService = /** @class */ (function () {
    function NumbersService(_httpClient, _toastController, _authService) {
        this._httpClient = _httpClient;
        this._toastController = _toastController;
        this._authService = _authService;
    }
    NumbersService.prototype.UploadProgress = function (level) {
        var _this = this;
        var url = environment_1.environment.api + '/numbers/add';
    ...
    NumbersService.prototype.checkUserLogged = function () {
        this.authUser = this._authService.isUserRegistered();
    };
    NumbersService.prototype.OpenSnackbar = function (message) {
